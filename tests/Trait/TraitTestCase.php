...
abstract class TraitTestCase extends FormTestCase {
    ...
    public function setUp(): void
    {
        ...
        User::create(['name' => 'John', 'email' => 'email@test', 'status' => \Momenoor\FormBuilder\Helpers\StaticLabel::STATUS_ONLINE]);
    }
...
class FormController extends \Illuminate\Routing\Controller implements \Momenoor\FormBuilder\Contracts\FormStateContract {
    ...
    public function buildForm()
    {
        $this
            ...
            ->add('status', 'choice', [
                ...
                'empty_value' => '-',
                'validation'  => 'required',
                'selected'    => \Momenoor\FormBuilder\Helpers\StaticLabel::STATUS_ONLINE,
                'label'       => 'status'
            ]);
...
class ValidationFormController extends \Illuminate\Routing\Controller implements \Momenoor\FormBuilder\Contracts\FormStateContract {
...
class SaveFormController extends \Illuminate\Routing\Controller implements \Momenoor\FormBuilder\Contracts\FormStateContract {
...
class AfterSaveFormController extends \Illuminate\Routing\Controller implements \Momenoor\FormBuilder\Contracts\FormStateContract {
