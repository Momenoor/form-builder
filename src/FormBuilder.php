...
use Momenoor\FormBuilder\Events\AfterFormCreation;
...
class FormBuilder
{
     ...
     *
     * @param string $formClass The name of the class that inherits \Momenoor\FormBuilder\Form.
     ...
     *
     * @param \Momenoor\FormBuilder\Form $instance
     * @param array $options
     * @param array $data
     * @return \Momenoor\FormBuilder\Form
     */
