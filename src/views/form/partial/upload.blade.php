...
@if ($showField)
    ...
    @else
        <div class="input-group">
            ...
            <span class="input-group-btn">
                <button type="button" class="btn blue"
                    onclick="moxman.browse({
                                      @if (!empty($options['extensions'])) extensions: '{{ $options['extensions'] }}', @endif
                                      @if (!empty($options['view'])) view: '{{ $options['view'] }}', @endif
                                              fields: '{{ $id }} ',
                                              no_host: true
                                              });">
            ...
            <script type="text/javascript" src='{{ config('app.url') }}/assets/moxiemanager/js/moxman.loader.min.js'></script>
    @endif
@endif
