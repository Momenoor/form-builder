                ...
                @if ($options['multiple'] == 'true')
                    ...
                    for (var i = 0; i < data.length; i++) {
                        ...
                        @foreach ($options['formatter']['libelle'] as $libelle)
                            ...
                            if (typeof(item.{!! $libelle !!}) != 'undefined' && item
                                .{!! $libelle !!} != null) {
        ...
        @else
            ...
            jQuery("input[name='{!! $name !!}']").select2({
                ...
                initSelection: function(element, callback) {
                    ...
                    if (elt.length > 0) {
                        jQuery.ajax({
                            ...
                            data: {
                                'ids': elt,
                                'local_override': jQuery("input[name='local_override']")
                                    .val(),
                ...
                formatInputTooShort: function(input, min) {
                    ...
                    return "{{ trans('form-builder::form.please_enter_n_or_more_character') }}"
                        .replace(':number', n);
                },
                formatSelectionTooBig: function(limit) {
                    return "{{ trans('form-builder::form.you_can_only_select_n_items') }}".replace(
                        ':number', limit);
                },
